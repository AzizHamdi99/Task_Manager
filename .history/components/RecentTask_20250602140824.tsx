        ...
        <div className='p-6 bg-white rounded-xl shadow-md flex flex-col gap-3.5'>
            <div className='flex items-center justify-between'>
                ...
                <Link href={"/dashboard/Tasks"}>
                    <div className='flex gap-1 bg-[#f8f8fc] p-2 items-center rounded-md hover:text-white hover:bg-blue-700 transition-all'>
            ...
            <div>
                ...
                <div>
                    {sortedTasks.map((t) => (
                        <div className='cursor-pointer' onClick={() => router.push(`/dashboard/task/${t._id}`)}>
