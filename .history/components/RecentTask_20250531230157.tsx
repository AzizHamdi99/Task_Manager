                    ...
                    {sortedTasks.map((t) => (
                        <div>
                            ...
                            <div className='grid grid-cols-[3fr_1fr_1fr_1fr] px-2 py-4'>
                                ...
                                <p className={t.status === "Pending" ? "bg-[#f2e3fb] text-[#8749bd] text-sm p-1 max-w-fit px-3 rounded-md" : t.status === "In Progress" ? "bg-blue-300 text-blue-500" : "bg-[#c1e9d1] text-[#66af7d]"}>{t.status}</p>
                                <p>{t.priority}</p>
