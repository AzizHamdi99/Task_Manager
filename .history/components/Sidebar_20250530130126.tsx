    ...
    return (
        <div className=' border-r-1 border-gray-200 w-1/6 shadow-sm h-screen flex flex-col '>
            ...
            <div className='flex flex-col '>
                <Link href={"/dashboard"}>
                    <div className={path === "/dashboard" ? "flex gap-3 p-3 bg-amber-100" : "flex gap-3 p-3 bg-amber-700"}>
                        <LayoutDashboard />
                        <p>Dashboard</p>
                    </div>
                ...
                {user?.role === "ADMIN" ? <div>
                    ...
                    <Link href={"/dashboard/Admintasks"}>
                        <div className={path === "/dashboard/tasks" ? "flex gap-3 p-3 bg-amber-100" : "flex gap-3 p-3 bg-amber-700"}>
                            <ClipboardCheck />
                            <p>Manage Tasks</p>
                        </div>
                    ...
                    <Link href={"/dashboard/create-task"}>
                        <div className={path === "/dashboard/create-task" ? "flex gap-3 p-3 bg-amber-100" : "flex gap-3 p-3 bg-amber-700"}>
                            <BookPlus />
                            <p>Create Task</p>
                        </div>
                    ...
                    <Link href={"/dashboard/TeamMembers"}>
                        <div className={path === "/dashboard/TeamMembers" ? "flex gap-3 p-3 bg-amber-100" : "flex gap-3 p-3 bg-amber-700"}>
                            <UserRound />
                            <p>Team Members</p>
                        </div>
