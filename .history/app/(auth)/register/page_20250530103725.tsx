            ...
            <form onSubmit={handelSubmit} className=" flex flex-col gap-2 mt-5" action="">
                <div className='grid grid-cols-2 items-center gap-3'>
                    ...
                    <div className='flex gap-2 flex-col mt-4'>
                        ...
                        <input value={data.code} name='code' onChange={handelChange} className='p-2 bg-slate-100 border outline-none border-gray-300 border-[1px] rounded-sm px-3' type="email" placeholder='6 Digit Code' />
                    </div>
                </div>
