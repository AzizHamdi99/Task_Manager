  ...
  return (
    <div className='flex flex-col'>
      ...
      <form className=" flex flex-col gap-2 mt-5" action="">
        ...
        <Link className='w-xl bg-blue-600 text-white text-center py-3 my-3 rounded-md text-[15px] hover:text-blue-500 hover:bg-blue-300 ' href={'/'}><button className='uppercase' type='submit'>Login</button></Link>
      </form>
