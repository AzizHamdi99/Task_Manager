  ...
  return (
    <div className='flex flex-col'>
      ...
      <form className=" flex flex-col gap-2 mt-5" action="">
        ...
        <Link className='w-xl bg-blue-600 text-white text-center py-2 my-3 rounded-md text-md' href={'/'}><button className='uppercase' type='submit'>Login</button></Link>
      </form>
      <p className='text-[13px] font-medium'>Don't have an account? <Link className='text-blue-500 underline' href={'/register'}>SingUp</Link></p>
