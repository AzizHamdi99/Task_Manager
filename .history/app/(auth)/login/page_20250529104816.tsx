  ...
  return (
    <div className='flex flex-col'>
      ...
      <form className=" flex flex-col gap-2 mt-4" action="">
        ...
        <div className='w-xl flex justify-between border border-gray-300 border-[1px]'>
          <input className='p-2 w-xl bg-slate-100  rounded-sm px-3' type="password" placeholder='Min 8 characters' />
          dd
        </div>
