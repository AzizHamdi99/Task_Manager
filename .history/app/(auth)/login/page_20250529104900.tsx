  ...
  return (
    <div className='flex flex-col'>
      ...
      <form className=" flex flex-col gap-2 mt-4" action="">
        ...
        <input className='p-2 w-xl bg-slate-100 border border-gray-300 border-[1px] rounded-sm px-3' type="email" placeholder='john@exemple.com' />

        <label className='font-meduim text-[15px] text-gray-900 mt-4' htmlFor="">Password</label>
        <div className='w-xl flex justify-between border border-gray-300 border-[1px] bg-slate-100'>
          <input className='p-2 w-xl border-none outline-none   rounded-sm px-3' type="password" placeholder='Min 8 characters' />
          dd
        </div>
