  ...
  return (
    <div className='flex flex-col'>
      ...
      <form className=" flex flex-col gap-2 mt-5" action="">
        <label className='font-meduim text-[15px] text-gray-900 font-semibold' htmlFor="">Email Address</label>
        ...
        <Link className='w-xl bg-blue-600 text-white text-center py-3 my-3 rounded-md text-[15px]' href={'/'}><button className='uppercase' type='submit'>Login</button></Link>
      </form>
      <p className='text-[15px] font-medium'>Don't have an account? <Link className='text-blue-500 underline' href={'/register'}>SingUp</Link></p>
