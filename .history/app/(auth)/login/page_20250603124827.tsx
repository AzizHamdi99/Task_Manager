  ...
  return (
    ...
    <div className='flex flex-col'>
      ...
      <div className="hidden md:flex w-1/2 bg-blue-50 items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-indigo-600 opacity-80 z-0" />

        <div className="z-10 text-center px-8">
          <Image
            src="/cfec4784-a486-4319-bbaa-75449b00c2fc.png" // put the image in /public
            alt="Illustration"
            width={300}
            height={300}
            className="mx-auto mb-6 drop-shadow-lg rounded-lg"
          />
          <h3 className="text-white text-3xl font-semibold mb-3">Organize Better</h3>
          <p className="text-white text-md">
            Taskify helps your team work more efficiently with smart tools & clean design.
          </p>
        </div>
      </div>
