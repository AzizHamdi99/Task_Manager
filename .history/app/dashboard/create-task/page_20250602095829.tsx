                        ...
                        <DialogTrigger asChild>
                            {assignedUserIds.length > 0 ? (
                                <div className='flex -space-x-4 items-center cursor-pointer'>
                                    {assignedUserIds.slice(0, 3).map((id) => {
                                    ...
                                    {assignedUserIds?.length > 2 && <div className='bg-gray-200 text-center items-center px-3 py-1 rounded-full font-semibold'>+{assignedUser?.length - 3}</div>}
