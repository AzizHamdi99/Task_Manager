    ...
    return (
        <form className='flex flex-col m-6 gap-3 w-3xl rounded-xl shadow-md p-6 bg-white'>
            ...
            <div className='flex flex-col gap-1.5'>
                ...
                <input type="text" className='px-2 py-1.5 outline-none border-[1px] border-gray-200 w-full' placeholder='Create App UI' />
            </div>
            <div>
                <p className='text-[#2b2b2b] font-meduim text-sm' >Description</p>
