...
function page() {
    ...
    return (
        <form type="submit" className='flex flex-col m-6 gap-3 w-4xl rounded-xl shadow-md p-6 bg-white'>
            ...
            <button onSubmit={handelSubmitForm} className='uppercase'>Create task</button>
