    ...
    return (
        <form onSubmit={handelSubmitForm} className='flex flex-col m-6 gap-3 w-4xl rounded-xl shadow-md p-6 bg-white'>
            ...
            <div className='flex flex-col gap-1.5'>
                ...
                <textarea value={data.description} name="" id="" placeholder='Describe task' className='px-2 py-1.5 rounded-sm outline-none border-[1px] border-gray-200 w-full h-32' ></textarea>
            </div>
