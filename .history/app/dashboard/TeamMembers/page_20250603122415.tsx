                ...
                {users?.map((user, index) => (
                    <div className='bg-white p-4 rounded-md flex flex-col gap-3' key={index}>
                        <div className='flex items-center gap-3'>
                            <Image width={40} height={40} alt='pdp' src={user.pic || "/nppdp.webp"} className='rounded-full' style={{ width: "40px", height: "40px", objectFit: "cover" }} />
                            <div>
                        ...
                        <div className='flex items-center justify-between gap-3 text-[12px] font-semibold'>
                            ...
                            <div className='bg-[#f9f9f9] px-4 text-[#74c40d]'>
