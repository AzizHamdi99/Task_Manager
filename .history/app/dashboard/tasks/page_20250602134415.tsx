        ...
        <div className='p-6 flex flex-col gap-4'>
            ...
            <div className='grid grid-cols-3 gap-4 items-center '>
                {filteredTasks?.length > 0 ? (
                    ...
                    <div className="col-span-3 flex flex-col items-center justify-center text-center p-10 bg-white rounded-md h-screen shadow">
                        <ClipboardCheck size={200} />
                        <p className="text-xl font-semibold text-gray-600 mt-4">No tasks found</p>
                        <p className="text-sm text-gray-500">You don't have any {selected.toLowerCase()} tasks.</p>
                    </div>
                )}
