                    ...
                    return (
                        <div key={i} className='bg-white p-4 shadow-md rounded-md'>
                            <div className='flex gap-4 items-center'>
                                <p className={tasks?.status === "Pending" ? "bg-[#f2e3fb] text-[#8749bd] text-sm p-1 max-w-fit px-3 rounded-md" : tasks.status === "In Progress" ? "bg-blue-300 text-blue-500 text-sm p-1 max-w-fit px-3 rounded-md" : "bg-[#c1e9d1] text-[#66af7d] text-sm p-1 max-w-fit px-3 rounded-md"}>{task?.status}</p>
