            ...
            <div className='grid grid-cols-3 gap-4 items-center '>
                {filteredTasks?.map((task, i) => {
                    ...
                    return (
                        ...
                        <div onClick={handleClick} key={i} className='bg-white p-4 shadow-md rounded-md flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-350'>
