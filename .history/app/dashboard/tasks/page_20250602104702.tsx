...
function Tasks() {
    ...
    return (
        <div className='p-6 flex flex-col gap-4'>
            ...
            <div className='grid grid-cols-3 gap-4 items-center cursor-pointer hover:shadow-xl'>
                {filteredTasks?.map((task, i) => {
                    ...
                    const handleClick = () => {
                        if (user?.role === "admin") {
                            router.push(`/dashboard/updateTask/${task.id}`);
                        } else {
                    ...
                    return (
                        ...
                        <div onClick={handleClick} key={i} className='bg-white p-4 shadow-md rounded-md flex flex-col gap-2'>
