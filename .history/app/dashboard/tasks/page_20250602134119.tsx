        ...
        <div className='p-6 flex flex-col gap-4'>
            ...
            <div className='grid grid-cols-3 gap-4 items-center '>
                {filteredTasks?.length > 0 ? (
                    ...
                    <div className="col-span-3 flex flex-col items-center justify-center text-center p-10 bg-white rounded-md shadow">
                        <Image src="/no-tasks.svg" alt="No Tasks" width={150} height={150} />
