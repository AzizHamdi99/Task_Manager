                                ...
                                <div className='flex items-center justify-between '>
                                    <div className="flex -space-x-4">
                                        {assignedUser?.slice(0, 3).map((u, key) => (
                                            ...
                                            <Image className='rounded-full border-2 border-white' key={key} height={40} width={40} alt='pdp' src={u?.pic || "/nppdp.webp"} style={{ width: "40px", height: "40px", objectFit: "cover" }} />
