    ...
    return (
        <form onSubmit={handleSubmitForm} className='flex flex-col m-6 gap-3 w-4xl rounded-xl shadow-md p-6 bg-white'>
            <div className='flex items-center justify-between'>
                ...
                <Dialog>
                    <DialogTrigger className='flex gap-2 bg-red-100 p-1 rounded-sm px-2 text-sm cursor-pointer text-white bg-red-600'>
                        <Trash2 size={20} />
                        <p>Delete</p>
                    </DialogTrigger>
                    <DialogContent>
                        ...
                        <DialogFooter>
                            ...
                            <Button type="button" className='cursor-pointer' variant="destructive" onClick={handleDone}>Delete</Button>
                        </DialogFooter>
                    </DialogContent>
