    ...
    return (
        <div className='flex flex-col gap-3 m-6 bg-white rounded-xl p-6 w-4xl shadow-md'>
            ...
            <div className='flex flex-col gap-1'>
                ...
                <p className='font-meduim text-[#2b2b2b] '>{task?.description}</p>
            </div>
            <div className='flex justify-between items-center'>
                <div className='flex flex-col gap-1'>
                    <p className='text-[#696a73] font-semibold text-sm'>Priority</p>
                    <p className='font-meduim text-[#2b2b2b] '>{task?.priority}</p>
                </div>
                <div className='flex flex-col gap-1'>
                    <p className='text-[#696a73] font-semibold text-sm'>dueDate</p>
                    <p className='font-meduim text-[#2b2b2b] ' >{createdDate(new Date(task?.dueDate))}</p>
                </div>
                <div className='flex flex-col gap-1'>
