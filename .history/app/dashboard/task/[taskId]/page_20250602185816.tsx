    ...
    return (
        <div className='flex flex-col gap-3 m-6 bg-white rounded-xl p-6 w-4xl shadow-md'>
            <div className='flex justify-between items-center' >
                ...
                <p className={task?.status === "Pending" ? "bg-[#f2e3fb] text-[#8749bd] text-sm p-1 max-w-fit px-3 rounded-md" : task?.status === "In Progress" ? "bg-blue-100 text-blue-700 text-sm p-1 max-w-fit px-3 rounded-md font-semibold" : "bg-[#c7f8da] text-[#448b5b] text-sm p-1 max-w-fit px-3 rounded-md"} >{task?.status}</p>
            </div>
